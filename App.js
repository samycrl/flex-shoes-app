...
const s = StyleSheet.create({
  ...
  // Nav
   nav:           {position:'absolute',bottom:0,left:0,right:0,backgroundColor:W,borderTopWidth:1,borderTopColor:B,flexDirection:'row',height:62,...Platform.select({ios:{paddingBottom:0},android:{paddingBottom:8,height:70}})},
